...
INSERT INTO Review (id, BOOK_ID, revtext) VALUES (1, 1, 'Review 1 for Book 1');
INSERT INTO Review (id, BOOK_ID, revtext) VALUES (2, 1, 'Review 2 for Book 1');


-- Inserting two reviews for book with ID 2
INSERT INTO Review (id, BOOK_ID, revtext) VALUES (3, 2, 'Review 1 for Book 2');
INSERT INTO Review (id, BOOK_ID, revtext) VALUES (4, 2, 'Review 2 for Book 2');

-- Inserting two reviews for book with ID 3
INSERT INTO Review (id, BOOK_ID, revtext) VALUES (5, 3, 'Review 1 for Book 3');
INSERT INTO Review (id, BOOK_ID, revtext) VALUES (6, 3, 'Review 2 for Book 3');

-- Inserting two reviews for book with ID 4
INSERT INTO Review (id, BOOK_ID, revtext) VALUES (7, 4, 'Review 1 for Book 4');
INSERT INTO Review (id, BOOK_ID, revtext) VALUES (8, 4, 'Review 2 for Book 4');

-- Inserting two reviews for book with ID 5
INSERT INTO Review (id, BOOK_ID, revtext) VALUES (9, 5, 'Review 1 for Book 5');
INSERT INTO Review (id, BOOK_ID, revtext) VALUES (10, 5, 'Review 2 for Book 5');
